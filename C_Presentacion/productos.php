      ...
      <div class="datos">
        ...
        <div class="datosAgrupados">
          ...
          <div class="groupDatos">
            ...
            <input type="text" class="inputDatos" name="nombre_actualizar" id="nombre_producto_act" required>
          </div>

          <div class="groupDatos">
            <label for="descripcion_act" class="label">Descripción</label>
            <textarea class="inputDatos" name="descripcion_actualizar" id="descripcion_act" rows="3"></textarea>
          </div>

          <div class="groupDatos">
            <label for="codigo_act" class="label">Código <span class="requerido">*</span></label>
            <input type="text" class="inputDatos" name="codigo_actualizar" id="codigo_act" required>
          </div>

          <div class="groupDatos">
            <label for="stock_act" class="label">Stock <span class="requerido">*</span></label>
            <input type="number" class="inputDatos" name="stock_actualizar" id="stock_act" min="0" required>
          </div>

...
const buttonContentPairs = [
    ...
    { selector: '.registrarVenta', contentId: 'contenidoRegistrarVenta' },
    { selector: '.buscarVenta', contentId: 'contenidoListaVenta' },
    { selector: '.btnEditar', contentId: 'modal' },
...
const btncanelarActualizarVenta = document.getElementById('btncancelarActualizarVenta');

btncanelarActualizar.addEventListener('click', (Event) => {
    Event.preventDefault();
    const dialogActualizar = document.getElementById('modalActualizarVenta');
    dialogActualizar.close();
});